      ...
      <div className="screen">
        ...
        <div className="signIn-form">
          <form action="">
            ...
            <input className="textBox focus-effect" name="email" type="email" />
            <label htmlFor="password">Password</label>
            <p className="forgot-pass">Forgot your password?</p>
            <input className="textBox focus-effect " type="password" />
            <button className="btn1 focus-effect">Sign-In</button>
            <p className="privacy">
            ...
            <button onClick={signUpHandler} className="btn1 new-account focus-effect">
